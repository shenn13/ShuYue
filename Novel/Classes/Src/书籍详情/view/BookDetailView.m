...
//        CGFloat coverW = 60.0f;
//        
//        CGFloat coverH = 80.0f;
...
//            label.displaysAsynchronously = YES;
        ...
        //标签tags
//        NSArray *tags = @[@"玄幻",@"热血",@"架空",@"异界大陆",@"巅峰",@"修炼",@"主宰",@"城市修真",@"啊啊啊啊",@"上了飞机龙卷风"];
        
//        _tagsView = [[MSSAutoresizeLabelFlow alloc] initWithFrame:CGRectMake(leftX, underLine.maxY_pro, kScreenWidth - leftX*2, 50) titles:tags selectedHandler:^(NSUInteger index, NSString *title) {
//            NSLog(@"%@",title);
//        }];
//        
...
//        CGFloat h = topY + coverH + coverWithBtnSpace + btnH + bottomH + lineH + threeLabelH + 5;
//        
//        _height += h;
...
//    /book/51d11e782de6405c45000068/recommend
    ...
    [httpUtil GET:NSStringFormat(@"%@/book/%@/recommend",SERVERCE_HOST,_model._id) parameters:nil success:^(id responseObject) {
