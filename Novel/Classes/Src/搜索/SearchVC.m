...
- (void)setupUI {
    ...
    YYLabel *everyLabel = [[YYLabel alloc] initWithFrame:CGRectMake(10, _searchBar.maxY_pro + 65, 120, 40)];
    everyLabel.font = FONT_SIZE(16);
    everyLabel.text = @"热门搜索:";
    [_topView addSubview:everyLabel];
    
    UIButton *replaceButton = [[UIButton alloc] initWithFrame:CGRectMake(kScreenWidth - 100, _searchBar.maxY_pro + 65, 100, 40)];
