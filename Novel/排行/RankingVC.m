...
- (void)onLoadDataByRequest {
    ...
    [Http GET:NSStringFormat(@"%@/ranking/gender",SERVERCE_HOST) parameters:@{@"timestamp":[DateTools getTimeInterval],@"platform":@"ios"} success:^(id responseObject) {
